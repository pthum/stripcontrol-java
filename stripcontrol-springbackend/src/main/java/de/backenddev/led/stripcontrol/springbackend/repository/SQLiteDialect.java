...
public class SQLiteDialect extends Dialect
{
	...
	{
		@Override
		public String processSql( final String sql, final RowSelection selection )
		{
	...
	{
		@Override
		protected String doExtractConstraintName( final SQLException sqle ) throws NumberFormatException
		{
	...
	{
		private SQLiteUniqueDelegate( final Dialect dialect )
		{
			super( dialect );
		}
